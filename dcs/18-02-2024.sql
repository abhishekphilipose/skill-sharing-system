...
(1,2,2,'hi','2024-01-04'),
(2,2,1,'hii','2024-01-05'),
(3,1,2,'hii','2024-01-05'),
(4,2,2,'hio','2024-01-05'),
(5,2,1,'hdh','2024-01-05'),
(6,1,2,'hloobkuttaa','2024-01-05'),
(7,1,2,'hloobkuttaa','2024-01-05'),
(8,1,2,'hloobkuttaa','2024-01-05'),
(9,1,2,'hloobkuttaa','2024-01-05'),
(10,1,2,'hloobkuttaa','2024-01-05'),
(11,1,2,'hloobkuttaa','2024-01-05'),
(12,1,2,'hloobkuttaa','2024-01-05'),
(13,1,2,'hloobkuttaa','2024-01-05'),
(14,2,1,'hi','2024-01-05');
...
(1,'anu','12345','user'),
(2,'maya','12344','user'),
(3,'adam','Adam@123','proffessional'),
(4,'anju','Anju@123','staff');
...
insert  into `notes`(`notes_id`,`staff_id`,`notes`,`date`) values 
(1,1,'static/3a54c826-e6ed-4ae7-aaf4-6ac0715ae356download (11).jpg','2024-02-18');
...
DROP TABLE IF EXISTS `proffessional`;

CREATE TABLE `proffessional` (
...
/*Data for the table `proffessional` */

insert  into `proffessional`(`pid`,`login_id`,`fn`,`ln`,`phone`,`place`,`email`) values 
(1,3,'Adam','k','kochi','9988776655','adam98@gmail.com');
...
(1,4,'anjaily','John','kochi','9911445566','anjali98@gmail.com');
...
insert  into `upload`(`upload_id`,`pid`,`upload`,`date`) values 
(6,1,'static/3a54c826-e6ed-4ae7-aaf4-6ac0715ae356download (11).jpg','2024-02-18');
